...
class PipelineConfig(BaseModel):
    ...
    kb: KnowledgeBaseConfig = Field(default=KnowledgeBaseConfig(), description="Configuration for the Knowledge Base (RAG).")
    voice: Optional[VoicePipelineConfig] = Field(default=None, description="Configuration for voice conversion pipeline.")
