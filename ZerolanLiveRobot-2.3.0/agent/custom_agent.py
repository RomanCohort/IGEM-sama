...
from agent.tool.igem_knowledge import IGEMKnowledgeTool
from agent.tool.interactive import get_interactive_tools
...
# iGEM团队协作功能工具
from agent.tool.meeting_tool import MeetingTool
from agent.tool.task_board_tool import TaskBoardTool
from agent.tool.bio_workflow_tool import BioWorkflowTool
from agent.tool.doc_hub_tool import DocHubTool
...
class CustomAgent:
    ...
    def __init__(self, config: LLMPipelineConfig, driver: Firefox | Chrome = None,
        ...
        tools = [BaiduBaikeTool(), LangChanger(), MicrophoneTool(), IGEMKnowledgeTool()]
        # Interactive tools (quiz, lottery, vote, countdown)
        ...
        # iGEM团队协作功能工具
        tools.extend([MeetingTool(), TaskBoardTool(), BioWorkflowTool(), DocHubTool()])
        self._tools = {}
